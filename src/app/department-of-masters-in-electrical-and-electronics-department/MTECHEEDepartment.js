      ...
      <div className='relative h-[90vh] max-lg:h-full bg-cover'>
        ...
        <div className='relative max-w-[1400px] mx-auto h-full w-full grid grid-cols-3 px-10 max-sm:px-3'>
          <div className='col-span-1 flex flex-col justify-center max-lg:items-center text-white max-lg:col-span-3 max-lg:pt-40'>
            <span className='text-xl sm:text-2xl max-sm:text-center font-novaReg'>Masters in Engineering</span>
            <h2 className='font-novaReg max-md:text-center text-3xl sm:text-4xl'>Electrical & Electronics Engineering</h2>
      ...
      <main className='max-w-[1400px] max-[1450px]:container mx-auto py-10 px-10 max-sm:px-2'>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div>
              <h2 className="text-3xl font-novaReg">M.TECH Electrical & Electronics Engineering</h2>
              <p className="my-5 tracking-tight font-novaReg text-start leading-5">
                The M.Tech program in Electrical and Electronics Engineering at AKGU is designed to provide advanced knowledge in power systems, control engineering, electric drives, and renewable energy technologies. The program combines strong theoretical foundations with practical applications to meet the evolving demands of the industry and research sectors.
              </p>
              <p className="leading-5 text-start font-novaReg">
                With access to modern laboratories and experienced faculty guidance, students are encouraged to undertake research, industry projects, and innovation-driven learning. The curriculum is tailored to enhance analytical and technical skills, preparing graduates for professional roles in core industries, higher education, and research organizations.
              </p>

            </div>
            <div>
              <h2 className='font-novaReg text-2xl'>Scope</h2>
              <p className='mt-2 font-novaReg'>  M.Tech in Electrical and Electronics Engineering offers broad scope in industries focusing on power generation and distribution, smart grid technologies, electric vehicles, automation, and renewable energy systems. With growing global emphasis on sustainable and efficient energy solutions, professionals with advanced EEE expertise are in high demand for roles in research, development, system design, and consultancy across public and private sectors. The program also opens pathways for doctoral studies and academic careers.
              </p>
            </div>
          </div>
        ...
        <div className="space-y-8">
          <div>
            <h1 className="text-2xl font-novaReg text-gray-800 mb-2">
              AKG University M.TECH EEE Admission Eligibility & Fees
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-white font-novaReg leading-relaxed">
                Graduates of M.Tech in Electrical and Electronics Engineering have strong career prospects in core sectors such as power systems, automation, energy management, electric vehicles, and control engineering. They can work as design engineers, power analysts, project consultants, or R&D professionals in leading companies, utilities, and government organizations. Many also pursue careers in academia, public sector undertakings, or advanced research through Ph.D. programs in India and abroad.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-white font-novaReg mb-4">
                Some of the leading companies hiring Electrical Engineers include:
              </p>
